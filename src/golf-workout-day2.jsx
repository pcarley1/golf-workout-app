...
// ── Day 2 · Full gym · Strength emphasis, deliberately NON-overlapping with the
//    home session (which hit lead-leg SL work, posting, rotation, shoulder ER).
//    Today: bilateral lower push, upper push/pull, anti-extension core.
const WORKOUT = [
  {
    id: "warmup",
    label: "Warm-up",
    ...
    dur: 6 * 60,
    color: "#4A9D8E",
    note: "Broad and easy — nothing that pre-fatigues today's lifts.",
    exercises: [
      { name: "Bike or row, easy", scheme: "3 min" },
      { name: "Cat-cow + hip airplanes", scheme: "8 / side" },
      { name: "Bodyweight squat to stand", scheme: "10 reps" },
      { name: "Scap pull-ups / band pull-aparts", scheme: "15 reps" },
      { name: "Glute bridge", scheme: "12 reps" },
    ],
  },
  {
    id: "blockA",
    label: "Block A — Bilateral Lower Strength",
    tag: "3 rounds · heavy",
    dur: 12 * 60,
    color: "#C8632D",
    note: "Two-legged and vertical — a different pattern from yesterday's single-leg hinging. Drive the floor, last 2 reps tough. Rest 90s.",
    exercises: [
      { name: "Barbell back squat (or trap-bar deadlift)", scheme: "5 reps", sets: 3 },
      { name: "DB or machine calf raise", scheme: "12 reps", sets: 3 },
    ],
  },
  {
    id: "blockB",
    label: "Block B — Upper Push / Pull",
    tag: "Superset · 3 rounds",
    dur: 11 * 60,
    color: "#C8632D",
    note: "Untouched by the golf-specific work so far. Full range, controlled. Rest 75s.",
    exercises: [
      { name: "Barbell or DB bench press", scheme: "6 reps", sets: 3 },
      { name: "Weighted pull-up or lat pulldown", scheme: "8 reps", sets: 3 },
    ],
  },
  {
    id: "blockC",
    label: "Block C — Vertical Push / Row",
    tag: "Superset · 3 rounds",
    dur: 9 * 60,
    color: "#C8632D",
    note: "Overhead and horizontal pull for balanced shoulders and upper back. Rest 60s.",
    exercises: [
      { name: "Standing DB overhead press", scheme: "8 reps", sets: 3 },
      { name: "Chest-supported DB row", scheme: "10 reps", sets: 3 },
    ],
  },
  {
    id: "blockD",
    label: "Block D — Anti-Extension Core",
    tag: "Superset · 3 rounds",
    dur: 6 * 60,
    color: "#C8632D",
    note: "Resisting extension protects the low back the golf swing hammers — and yesterday was all anti-rotation, so this fills the gap. Rest 45s.",
    exercises: [
      { name: "Ab wheel rollout (or long-lever plank)", scheme: "8 reps", sets: 3 },
      { name: "Hanging knee raise", scheme: "10 reps", sets: 3 },
    ],
  },
  {
    id: "cooldown",
    ...
    color: "#4A9D8E",
    exercises: [
      { name: "Child's pose + lat stretch", scheme: "45s" },
      ...
      <div style={{ maxWidth: 640, margin: "0 auto" }}>
        <div style={{ marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 13, color: "#888", margin: "8px 0 0", lineHeight: 1.5 }}>
            Bilateral lower, upper push/pull, anti-extension core — no overlap with yesterday.
          </p>
        </div>
        ...
        <p style={{ fontSize: 12, color: "#555", textAlign: "center", marginTop: 24, lineHeight: 1.6 }}>
          ...
          Heavier and lower-rep today — full recovery between sets is the point.
        </p>
      </div>
    </div>
  );
