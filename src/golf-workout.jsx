...
const WORKOUT = [
  {
    ...
    exercises: [
      ...
      { name: "Cat-cow", scheme: "8 reps" },
      { name: "Open books (T-spine rotation)", scheme: "8 / side" },
      { name: "Band pull-aparts", scheme: "15 reps" },
      { name: "Hip circles", scheme: "10 / side" },
    ],
  },
  {
    id: "blockA",
    label: "Block A — Power & Rotation",
    tag: "Superset · 3 rounds",
    dur: 9 * 60,
    color: "#C8632D",
    note: "Move fast and explosive. Rest 60s between rounds.",
    exercises: [
      { name: "Cable rotational chop (high→low)", scheme: "8 / side", sets: 3 },
      { name: "Landmine rotational press", scheme: "8 / side", sets: 3 },
    ],
  },
  {
    id: "blockB",
    label: "Block B — Strength & Hip Drive",
    tag: "Superset · 3 rounds",
    dur: 9 * 60,
    color: "#C8632D",
    note: "Last 2 reps should be tough. Rest 60s.",
    exercises: [
      { name: "Goblet squat", scheme: "10 reps", sets: 3 },
      { name: "Half-kneeling Pallof press", scheme: "10 / side · 2s hold", sets: 3 },
    ],
  },
  {
    id: "blockC",
    label: "Block C — Posterior Chain & Stability",
    tag: "Superset · 3 rounds",
    dur: 8 * 60,
    color: "#C8632D",
    note: "Slow and controlled. Rest 45s.",
    exercises: [
      { name: "Single-leg Romanian deadlift", scheme: "8 / leg", sets: 3 },
      { name: "Bird dog", scheme: "8 / side", sets: 3 },
    ],
  },
  {
    id: "blockD",
    label: "Block D — Rotational Finisher",
    tag: "Superset · 2 rounds",
    dur: 6 * 60,
    color: "#C8632D",
    note: "Med ball throws are all-out explosive.",
    exercises: [
      { name: "Med ball rotational wall throw", scheme: "10 / side", sets: 2 },
  ...
  },
  {
    ...
    color: "#4A9D8E",
    exercises: [
      { name: "Seated spinal twist", scheme: "30s / side" },
...
function Block({ block, expanded, onExpand }) {
  ...
  return (
    <div
      style={{
        background: "#161616",
        border: `1px solid ${expanded ? block.color : "#262626"}`,
        borderRadius: 14,
        padding: expanded ? "20px 22px" : "16px 22px",
        marginBottom: 12,
    ...
    >
      ...
      {expanded && (
        <div style={{ marginTop: 18 }}>
          {block.note && (
            <p style={{ fontSize: 13, color: "#9a9a9a", margin: "0 0 16px", lineHeight: 1.5 }}>{block.note}</p>
          )}
          ...
          >
            ...
            <div style={{ display: "flex", gap: 8 }}>
              <button
                onClick={() => t.setRunning((r) => !r)}
                style={{
                  padding: "9px 20px", borderRadius: 8, border: "none", cursor: "pointer",
                  fontWeight: 700, fontSize: 14,
                  background: t.running ? "#2a2a2a" : block.color,
                  color: t.running ? "#eee" : "#0d0d0d",
                }}
              >
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 640, margin: "0 auto" }}>
        ...
        >
          <div>
            <div style={{ fontSize: 11, color: "#777", textTransform: "uppercase", letterSpacing: ".1em" }}>
              Total session
            </div>
        ...
        <p style={{ fontSize: 12, color: "#555", textAlign: "center", marginTop: 24, lineHeight: 1.6 }}>
          ...
          No cable? Anchor a resistance band to a door for chops, Pallof, and presses.
        </p>
      </div>
    </div>
  );
